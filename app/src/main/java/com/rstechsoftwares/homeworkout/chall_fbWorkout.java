...
public class chall_fbWorkout extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lAdapter = new instrution_fbwokout(chall_fbWorkout.this, version, images);
        ...
        lView.setOnItemClickListener(
...

            {
                ...
                if(i==0)
                {
                    Intent intent=new Intent(chall_fbWorkout.this,easyplan1.class);
