...
public class instr_buttWorkout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lAdapter = new instrution_fbwokout(instr_buttWorkout.this, version, images);
    ...
    {
        Intent intent = new Intent(instr_buttWorkout.this, instr_fbWorkout_item.class);
