...
public class instr_fbWorkout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lAdapter = new instrution_fbwokout(instr_fbWorkout.this, version, images);
    ...
    {
        Intent intent = new Intent(instr_fbWorkout.this, instr_fbWorkout_item.class);
