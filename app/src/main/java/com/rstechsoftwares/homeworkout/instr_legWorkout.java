...
public class instr_legWorkout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lAdapter = new instrution_fbwokout(instr_legWorkout.this, version, images);
    ...
    {
        Intent intent = new Intent(instr_legWorkout.this, instr_fbWorkout_item.class);
