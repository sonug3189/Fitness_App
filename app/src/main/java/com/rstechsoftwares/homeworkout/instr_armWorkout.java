...
public class instr_armWorkout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lAdapter = new instrution_fbwokout(instr_armWorkout.this, version, images);
    ...
    {
        Intent intent = new Intent(instr_armWorkout.this, instr_fbWorkout_item.class);
